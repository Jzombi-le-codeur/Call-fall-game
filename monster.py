...
class Monster(pygame.sprite.Sprite): #Créer la classe des monstres
    """Définir les attributs"""
    def __init__(self, game): #Créer le constructeur de la classe
        super().__init__() #Dire à pygame que les monstres sont des éléments graphiques du jeu
        self.game = game
        ...
        self.image = pygame.image.load("assets/mummy.png") #Importer l'image des monstres
