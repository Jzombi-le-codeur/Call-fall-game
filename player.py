...
class Player(animation.AnimateSprite):  # Créer la classe du joueur
    ...
    def updade_health_bar(self, surface):  # Méthode pour définir la barre de vies
        ...
        pygame.draw.rect(surface, (60, 63, 60), [self.rect.x + 50, self.rect.y + 20, self.max_health,
                                                 5])  # Dessiner l'arrière-plan de la barre de vies
        pygame.draw.rect(surface, (111, 210, 46),
                         [self.rect.x + 50, self.rect.y + 20, self.health, 5])  # Dessiner la barre de vies
